...
## Project Structure
    ...
    ├── testapiautoteammem_110182  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_110182`
...
2. Clone this repo and `cd testapiautoteammem_110182`
